        ...
        <Modal.Body className={styles.poi_detail_ct}>
          ...
          <div className={styles.poi_info}>
            ...
            <div className={styles.floor_info}>
              <div className={styles.floor_poi}> <img src={IconLocation} alt="location icon"/> <span className={styles.floorTitle}>{floor?.title}</span><span className={styles.pipeCharacter}></span><span className={styles.categoryTitle}>{category?.title?.[language]}</span> </div>
