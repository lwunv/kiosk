      ...
      <Modal size="lg" className={styles.poi_detail} show={poiMapId ? true : false} onHide={handleClose}>
        <Modal.Body className={styles.poi_detail_ct}>
          ...
          <div className={styles.poi_info}>
            ...
            <div className={floor?.title ? styles.floor_poi : styles.displayNone}> <img src={IconLocation} alt="location icon"/> <span className={styles.floorTitle}>{floor?.title}</span> <span className={styles.pipeCharacter}></span><span className={styles.categoryTitle}>{category?.title?.[language]}</span></div>
